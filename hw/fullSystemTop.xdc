...
# =========================
# GPU clock (clk_slow_creator)
# =========================
create_generated_clock -name gpu_clk -source [get_pins clk_slow_creator_inst/inst/clk_in1] [get_pins clk_slow_creator_inst/inst/clk_out1]

set_clock_groups -asynchronous -group [get_clocks gpu_clk] -group [get_clocks -exclude gpu_clk *]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {memoryController_inst/writeCounter_debug_vga[0]} {memoryController_inst/writeCounter_debug_vga[1]} {memoryController_inst/writeCounter_debug_vga[2]} {memoryController_inst/writeCounter_debug_vga[3]} {memoryController_inst/writeCounter_debug_vga[4]} {memoryController_inst/writeCounter_debug_vga[5]} {memoryController_inst/writeCounter_debug_vga[6]} {memoryController_inst/writeCounter_debug_vga[7]} {memoryController_inst/writeCounter_debug_vga[8]} {memoryController_inst/writeCounter_debug_vga[9]}]]
connect_debug_port u_ila_0/probe1 [get_nets [list {memoryController_inst/curStateDebug_debug_vga[0]} {memoryController_inst/curStateDebug_debug_vga[1]}]]

connect_debug_port u_ila_0/probe1 [get_nets [list {memoryController_inst/rowColPlusFrameBuf_debug_vga[0]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[1]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[2]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[3]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[4]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[5]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[6]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[7]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[8]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[9]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[10]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[11]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[12]} {memoryController_inst/rowColPlusFrameBuf_debug_vga[13]}]]



connect_debug_port u_ila_0/probe0 [get_nets [list {memoryController_inst/frozen_row_col_index_reg_debug_vga[0]} {memoryController_inst/frozen_row_col_index_reg_debug_vga[1]} {memoryController_inst/frozen_row_col_index_reg_debug_vga[2]} {memoryController_inst/frozen_row_col_index_reg_debug_vga[3]} {memoryController_inst/frozen_row_col_index_reg_debug_vga[4]} {memoryController_inst/frozen_row_col_index_reg_debug_vga[5]} {memoryController_inst/frozen_row_col_index_reg_debug_vga[6]} {memoryController_inst/frozen_row_col_index_reg_debug_vga[7]} {memoryController_inst/frozen_row_col_index_reg_debug_vga[8]} {memoryController_inst/frozen_row_col_index_reg_debug_vga[9]} {memoryController_inst/frozen_row_col_index_reg_debug_vga[10]}]]
connect_debug_port u_ila_0/probe1 [get_nets [list {memoryController_inst/alexMemEnable_debug_vga[0]} {memoryController_inst/alexMemEnable_debug_vga[1]}]]
connect_debug_port u_ila_0/probe2 [get_nets [list {memoryController_inst/alexAddress_debug_vga[0]} {memoryController_inst/alexAddress_debug_vga[1]} {memoryController_inst/alexAddress_debug_vga[2]} {memoryController_inst/alexAddress_debug_vga[3]} {memoryController_inst/alexAddress_debug_vga[4]} {memoryController_inst/alexAddress_debug_vga[5]} {memoryController_inst/alexAddress_debug_vga[6]} {memoryController_inst/alexAddress_debug_vga[7]} {memoryController_inst/alexAddress_debug_vga[8]} {memoryController_inst/alexAddress_debug_vga[9]} {memoryController_inst/alexAddress_debug_vga[10]} {memoryController_inst/alexAddress_debug_vga[11]} {memoryController_inst/alexAddress_debug_vga[12]} {memoryController_inst/alexAddress_debug_vga[13]} {memoryController_inst/alexAddress_debug_vga[14]} {memoryController_inst/alexAddress_debug_vga[15]} {memoryController_inst/alexAddress_debug_vga[16]} {memoryController_inst/alexAddress_debug_vga[17]} {memoryController_inst/alexAddress_debug_vga[18]} {memoryController_inst/alexAddress_debug_vga[19]} {memoryController_inst/alexAddress_debug_vga[20]} {memoryController_inst/alexAddress_debug_vga[21]} {memoryController_inst/alexAddress_debug_vga[22]} {memoryController_inst/alexAddress_debug_vga[23]}]]
connect_debug_port u_ila_0/probe3 [get_nets [list {memoryController_inst/drawX_debug_vga[0]} {memoryController_inst/drawX_debug_vga[1]} {memoryController_inst/drawX_debug_vga[2]} {memoryController_inst/drawX_debug_vga[3]} {memoryController_inst/drawX_debug_vga[4]} {memoryController_inst/drawX_debug_vga[5]} {memoryController_inst/drawX_debug_vga[6]} {memoryController_inst/drawX_debug_vga[7]} {memoryController_inst/drawX_debug_vga[8]} {memoryController_inst/drawX_debug_vga[9]}]]
connect_debug_port u_ila_0/probe4 [get_nets [list {memoryController_inst/drawY_debug_vga[0]} {memoryController_inst/drawY_debug_vga[1]} {memoryController_inst/drawY_debug_vga[2]} {memoryController_inst/drawY_debug_vga[3]} {memoryController_inst/drawY_debug_vga[4]} {memoryController_inst/drawY_debug_vga[5]} {memoryController_inst/drawY_debug_vga[6]} {memoryController_inst/drawY_debug_vga[7]} {memoryController_inst/drawY_debug_vga[8]} {memoryController_inst/drawY_debug_vga[9]}]]
connect_debug_port u_ila_0/probe5 [get_nets [list {memoryController_inst/readCounter_debug_vga[0]} {memoryController_inst/readCounter_debug_vga[1]} {memoryController_inst/readCounter_debug_vga[2]} {memoryController_inst/readCounter_debug_vga[3]} {memoryController_inst/readCounter_debug_vga[4]} {memoryController_inst/readCounter_debug_vga[5]} {memoryController_inst/readCounter_debug_vga[6]} {memoryController_inst/readCounter_debug_vga[7]} {memoryController_inst/readCounter_debug_vga[8]} {memoryController_inst/readCounter_debug_vga[9]}]]
connect_debug_port u_ila_0/probe7 [get_nets [list {memoryController_inst/writeCounter_debug_vga[0]} {memoryController_inst/writeCounter_debug_vga[1]} {memoryController_inst/writeCounter_debug_vga[2]} {memoryController_inst/writeCounter_debug_vga[3]} {memoryController_inst/writeCounter_debug_vga[4]} {memoryController_inst/writeCounter_debug_vga[5]} {memoryController_inst/writeCounter_debug_vga[6]} {memoryController_inst/writeCounter_debug_vga[7]} {memoryController_inst/writeCounter_debug_vga[8]} {memoryController_inst/writeCounter_debug_vga[9]}]]
connect_debug_port u_ila_0/probe9 [get_nets [list memoryController_inst/alexCommandAcknowledged_debug_vga]]
connect_debug_port u_ila_0/probe12 [get_nets [list memoryController_inst/alexFinishedMemAction_debug_vga]]
connect_debug_port u_ila_0/probe14 [get_nets [list memoryController_inst/alexNewCommand_debug_vga]]
connect_debug_port u_ila_0/probe16 [get_nets [list memoryController_inst/processingAlexCommand_debug_vga]]
connect_debug_port u_ila_0/probe26 [get_nets [list memoryController_inst/vgaLoadWhenReady_debug_vga]]
# On-board LEDs
